...
tools: list_orders, get_order, get_logistics, search_faq, create_ticket, delegate_aftersale
description: 退换货标准作业流程
---
# 退换货 SOP

1. 用 get_order 核实订单:确认商品、金额、状态；未提供订单号时先用 list_orders 列出当前买家的订单，请买家选择。
